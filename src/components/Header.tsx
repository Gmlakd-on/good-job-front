      ...
      <div className="site-header__inner">
        ...
        {user && (
          <nav className="site-header__nav">
            <NavLink href="/books" label="내 책장" />
            <NavLink href="/exchange" label="교환일기" />
            <NavLink href="/report" label="감정 리포트" />
          </nav>
        )}
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <>
              ...
              {/* 설정 아이콘 */}
              <Link href="/settings" className="flex h-8 w-8 items-center justify-center rounded-md transition-all hover:bg-[rgba(74,52,40,0.04)]" aria-label="설정">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" style={{ color: "var(--text-secondary)" }}>
              ...
              <div className="relative">
                <button type="button" onClick={() => setMenuOpen(!menuOpen)}
                  ...
                  style={{ background: "var(--paper-aged)", color: "var(--text-primary)" }} aria-label="메뉴">
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-11 z-20 min-w-[180px] overflow-hidden"
                      ...
                      <div className="p-1.5">
                        <MenuLink href="/books" label="내 책장" onClick={() => setMenuOpen(false)} />
                        <MenuLink href="/exchange" label="교환일기" onClick={() => setMenuOpen(false)} />
                        <MenuLink href="/notifications" label={unreadCount > 0 ? `알림 (${unreadCount})` : "알림"} onClick={() => setMenuOpen(false)} />
